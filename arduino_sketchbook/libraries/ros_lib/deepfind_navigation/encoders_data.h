#ifndef _ROS_deepfind_navigation_encoders_data_h
#define _ROS_deepfind_navigation_encoders_data_h
...
namespace deepfind_navigation
{
  ...
  class encoders_data : public ros::Msg
  {
    ...
    const char * getType(){ return "deepfind_navigation/encoders_data"; };
